...
const char* SQL="CREATE TABLE foo(a char(50)); INSERT INTO FOO VALUES(\"id-1 Carrot kilo 123 12 12 13 1 2020 52\"); INSERT INTO FOO SELECT * FROM FOO;";
//work only to const??? problem with column, geom prog, I dont know why...
 int main(int argc, char** argv) {
	...
	// open
	if (sqlite3_open("test_1.dblite", &db))
...
//		//SQL = "CREATE TABLE foo(a char(50)); INSERT INTO FOO VALUES(\"
