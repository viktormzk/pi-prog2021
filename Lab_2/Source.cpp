...
int main(){
	...
	if (mode==2) {
	 ...
	 if (mode==3) {
	 	std::ofstream input("result.txt");
	 	int i=0;
	 	unsigned int start=0, end=0,search=0;
	 	
		input<< "Create empty(x100): ";
		start=clock();
		create_empty(my_list);
		create_empty(my_list);
		create_empty(my_list);
		...
		search=end-start;
		input << search <<" ms"<< std::endl;
		
		input << "Add 1 item(1,1,1)(*100): ";
		start=clock();
		my_list.append({1,1,1});
		my_list.append({1,1,1});
		my_list.append({1,1,1});
		...
		input << "Add 1 item(212312.213213,41231231.213123112,2.12312312311)(*100): " ;
		start=clock();
		...
		input << "Insert 1 item(12312312.1323123,5123123.12314325,7345345345.14124124)(*100): ";
		start=clock();
